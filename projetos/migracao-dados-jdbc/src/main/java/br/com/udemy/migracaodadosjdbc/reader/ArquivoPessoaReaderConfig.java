...
import br.com.udemy.migracaodadosjdbc.dominio.Pessoa;
...
public class ArquivoPessoaReaderConfig {
    ...
    public FlatFileItemReader<Pessoa> arquivoPessoaReader() {
        return new FlatFileItemReaderBuilder<Pessoa>()
                ...
                .resource(new FileSystemResource("projetos/migracao-dados-jdbc/files/pessoas.csv"))
                .delimited()
                .names("nome", "email", "dataNascimento", "idade", "id")
                .addComment("--")

                //necessário criar o mapeador customizado, pois existe a data de nascimento
